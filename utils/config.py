...
parser.add_argument(
    "-loadEmb",
    "--load_embedding",
    help="Load Pretrained Glove and Char Embeddings",
    required=False,
    default=False,
    type=bool,
)
...
parser.add_argument(
    "--warmup_proportion",
    help="warm up training in the begining",
    required=False,
    default=0.1,
    type=float,
)
...
parser.add_argument("--output_mode", default="classification", type=str, help="")
parser.add_argument(
    "--max_steps",
    default=-1,
    type=int,
...
parser.add_argument("--rand_seed", default=0, type=int, help="")
parser.add_argument(
    "--fix_rand_seed",
    action="store_true",
...
parser.add_argument(
    "-dpath",
    "--data_path",
    help="path to dataset folder, need to change to your local folder",
    required=False,
...
parser.add_argument(
    "-task",
    "--task",
    help='task in ["nlu", "dst", "dm", "nlg", "usdl"] to decide which dataloader to use',
    required=True,
)
parser.add_argument(
    "-task_name",
    "--task_name",
    help='task in ["intent", "sysact","rs"]',
    required=False,
    default="",
)
parser.add_argument(
...
parser.add_argument(
    "-load_path",
    "--load_path",
    help="path of the saved model to load from",
    required=False,
)
parser.add_argument(
    "-an",
    "--add_name",
    help="An added name for the save folder",
    required=False,
    default="",
)
parser.add_argument(
...
parser.add_argument("--save_steps", default=1000, type=int, help="")
parser.add_argument(
    "--save_total_limit",
    type=int,
    default=2,
...
parser.add_argument("--not_save_model", action="store_true", help="")
...
parser.add_argument("--create_own_vocab", action="store_true", help="")
parser.add_argument(
    "-um",
    "--unk_mask",
...
parser.add_argument(
    "--gate_supervision_for_dst",
    action="store_true",
    help="",
)
parser.add_argument(
    "--sum_token_emb_for_value",
    action="store_true",
    help="",
)
parser.add_argument("--nb_neg_sample_rs", default=0, type=int, help="")
parser.add_argument(
    "--sample_negative_by_kmeans",
    action="store_true",
    help="",
)
parser.add_argument("--nb_kmeans", default=1000, type=int, help="")
parser.add_argument(
    "--bidirect",
    action="store_true",
    help="",
...
parser.add_argument(
    ...
    default="",
    type=str,
    help="1.0 is the cleaned version but not used",
)
parser.add_argument(
    "--dstlm",
    action="store_true",
